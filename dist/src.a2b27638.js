...
function getEpisodes() {
  return fetch("https://rickandmortyapi.com/api/episode").then(function (response) {
    return response.json();
  });
}
function getLocations() {
  return fetch("https://rickandmortyapi.com/api/location").then(function (response) {
    return response.json();
  });
}
...
exports.showLocations = exports.showEpisodes = exports.showCharacter = exports.createCharacterRow = void 0;
...
var showEpisodes = function showEpisodes(episode) {
  var episodesList = document.getElementById("character-detail");
  var element = episodesList.appendChild(createList(episode.episode + ": " + episode.name));
  return element;
};
exports.showEpisodes = showEpisodes;
var showLocations = function showLocations(location) {
  var locationsList = document.getElementById("character-detail");
  var element = locationsList.appendChild(createList(location.name + " (" + location.type + ")"));
  return element;
};
...
var createList = function createList(text) {
...
require("./styles.css");
var Data = _interopRequireWildcard(require("./data-business"));
...
Data.getCharacters().then(function (char) {
  document.getElementById("root").innerText = "";
  var characters = char.results;
  var list = [];
  ...
  try {
    var _loop = function _loop() {
      ...
      var element = Utils.createCharacterRow(char);
...
function listEpisodes() {
  Data.getEpisodes().then(function (episode) {
    document.getElementById("character-detail").innerText = "";
    var episodes = episode.results;
    var _iterator2 = _createForOfIteratorHelper(episodes),
      _step2;
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        var _episode = _step2.value;
        var element = Utils.showEpisodes(_episode);
...
function listLocations() {
  Data.getLocations().then(function (location) {
    document.getElementById("character-detail").innerText = "";
    var locations = location.results;
    var _iterator3 = _createForOfIteratorHelper(locations),
      _step3;
    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        var _location = _step3.value;
        var element = Utils.showLocations(_location);
